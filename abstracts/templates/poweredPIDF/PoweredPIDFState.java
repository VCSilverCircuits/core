...
public class PoweredPIDFState<S extends PoweredPIDFState<S, P>, P extends PoweredPIDFPose>
    extends State<S> {
  ...
  public void setTargetPosition(
      Action<S> action, double targetPosition, boolean suppressNotification) {
    assertLock(action);
